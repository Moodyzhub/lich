            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    setNewLessonData({ ...newLessonData, lessonType: value as 'Video' | 'Reading' });
                    if (value === 'Reading') setVideoUrlError('');
                  }}
                >
                  <SelectTrigger>
                    <SelectValue />
      ...
      >
        <DialogContent className="sm:max-w-xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="new-resource-url">URL tài nguyên</Label>
              <Input
                id="new-resource-url"
              ...
              />
              {resourceUrlError && <p className="text-sm text-red-600 mt-1">{resourceUrlError}</p>}
            </div>
          </div>
          <DialogFooter>
            <Button
        ...
        <DialogContent className="sm:max-w-xl">
          ...
          {editingResourceData && (
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="resource-url">URL tài nguyên</Label>
                <Input
                  id="resource-url"
