...
const QuizContent = ({ lesson, courseId }: QuizContentProps) => {
  ...
  return (
    <div className="lg:col-span-2">
      ...
      {/* Previous Result Banner - Show if user has done quiz before and not currently showing results */}
      {!showResults && previousResult && (
        <Card className="mb-6 overflow-hidden shadow-lg border-2 border-blue-200">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <span className="text-gray-600">
                      Điểm: <span className="font-bold text-blue-600">{previousResult.totalScore}/{previousResult.maxScore}</span>
                    </span>
                    <span className="text-gray-600">
                      Phần trăm: <span className="font-bold text-green-600">{previousResult.percentage}%</span>
                    </span>
                    <span className="text-gray-600">
                      Đúng: <span className="font-bold text-green-600">{previousResult.correctQuestions}/{previousResult.totalQuestions}</span>
                    </span>
                  </div>
                </div>
              </div>
