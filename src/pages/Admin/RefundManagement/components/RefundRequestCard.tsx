...
const RefundRequestCard = ({ request, onApprove, onReject }: RefundRequestCardProps) => {
      ...
      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
        <div className="flex items-start gap-4 flex-1">
          <Avatar className="w-16 h-16 border-2 border-white shadow-md ring-2 ring-slate-100">
            <AvatarImage src="" alt={request.bankOwnerName || 'User'} />
            <AvatarFallback className="bg-gradient-to-br from-blue-500 to-blue-600 text-white font-semibold">
              {request.bankOwnerName?.split(' ').map((n) => n[0]).join('') || 'U'}
            </AvatarFallback>
          </Avatar>
