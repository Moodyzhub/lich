    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl shadow-lg p-8 text-white mb-8">
          ...
          <p className="text-blue-100 text-lg">Xem xét và xử lý các yêu cầu hoàn tiền từ học viên</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-blue-100 font-medium">Chờ xử lý</span>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-blue-100 font-medium">Đã gửi</span>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-blue-100 font-medium">Đã duyệt</span>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-blue-100 font-medium">Từ chối</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {filters.map((filter) => (
                  <Button
                    ...
                    className={activeFilter === filter.value ? 'bg-blue-600 hover:bg-blue-700' : ''}
                    size="sm"
                  >
                    {filter.label}
                  </Button>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className={sortOrder === 'newest' ? 'bg-blue-600 hover:bg-blue-700' : ''}
                  size="sm"
                >
                  Mới nhất
                </Button>
                <Button
                  ...
                  className={sortOrder === 'oldest' ? 'bg-blue-600 hover:bg-blue-700' : ''}
                  size="sm"
                >
                  Cũ nhất
                </Button>
