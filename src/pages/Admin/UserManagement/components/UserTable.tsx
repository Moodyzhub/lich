        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="min-w-[80px]" scope="col">Giới tính</TableHead>
              <TableHead className="min-w-[100px]" scope="col">Vai trò</TableHead>
              <TableHead className="min-w-[150px]" scope="col">Ngày tháng</TableHead>
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
        <div className="text-sm text-gray-600 text-center space-y-1 sm:space-y-0">
          <div className="flex flex-col sm:flex-row sm:justify-center sm:gap-4">
            ...
            <span>Hoạt động: {users.filter(u => u.isActive).length}</span>
            <span className="hidden sm:inline text-gray-400">•</span>
            <span>Không hoạt động: {users.filter(u => !u.isActive).length}</span>
          </div>
        </div>
      </div>
    </div>
